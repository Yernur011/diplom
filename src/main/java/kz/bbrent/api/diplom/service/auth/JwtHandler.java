...
import kz.bbrent.api.diplom.domain.dto.auth.AccessToken;
import kz.bbrent.api.diplom.domain.dto.auth.RefreshToken;
    ...
    public String extractUsername(String token) {
        ...
        if ("ACCESS_TOKEN".equals(tokenDetails.get("type"))){
            ...
            return Try.of(() -> accessToken)
                    ...
                    .getOrElseThrow(ex -> new ApiException("Invalid token ", ex));
